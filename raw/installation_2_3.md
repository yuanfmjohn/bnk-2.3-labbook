...
#2 k8s yamls for nfs and macvlan net-attach-def creation
#1 env.sh script for env varialbeble in installation
#2 scriptbash scripts from BNK site for manifest chart and version extraction as well as 
#1 bash script for far-pull-secret creation
#3 yamlsBNK yamls for 1) otel certs creation; 2) f5- flo instlaallationallation; 3) f5 cne instance installation
#41 BNK yaml for sifinal step lijwt license creation.
...
# check if flot  is installed successfully.
